...
QUALITATIVE_STRENGTHS = {
    "+++": {"label": gettext("：著しく増加しています"), "color": "#ff0000"},
    "++": {"label": gettext("：増加しています"), "color": "#ff5252"},
    "+": {"label": gettext("：わずかに増加しています"), "color": "#ff7b7b"},
    "-": {"label": gettext("：わずかに減少しています"), "color": "#c8deff"},
    "--": {"label": gettext("：減少しています"), "color": "#afcdfb"},
    "---": {"label": gettext("：著しく減少しています"), "color": "#91bafb"},
}
